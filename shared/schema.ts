...
export const orders = pgTable("orders", {
  ...
  deliveryRetryCount: integer("delivery_retry_count").notNull().default(0),
  deliveryLastRetriedAt: text("delivery_last_retried_at"),
  deliveryLastRetriedBy: varchar("delivery_last_retried_by"),
  deliveryLastRetriedByEmail: text("delivery_last_retried_by_email"),
